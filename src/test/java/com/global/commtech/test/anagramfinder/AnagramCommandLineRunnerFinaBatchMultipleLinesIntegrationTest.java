...
@SpringBootTest(args = {"src/test/resources/example2-finalBatchHasMultipleLines.txt"})
@ExtendWith(OutputCaptureExtension.class)
class AnagramCommandLineRunnerFinaBatchMultipleLinesIntegrationTest {
    ...
    void shouldFindAnagrams(final CapturedOutput capturedOutput) {
        ...
        assertThat(capturedOutput.getOut()).contains("hello,lleho");
    }
